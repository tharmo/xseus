...
begin
  ...
  begin
    ...
    xseusserver.servs.freeths.add(self);
      ...
      logwrite('gname '+xseusformi.gname);
...
procedure Txseusformi.memolog(s: string);
begin
  // logmemo.Lines.add(s);
end;

procedure Txseusformi.FormCreate(Sender: TObject);
var
  inif: string;
  i: integer;
begin
...
procedure Txseusformi.FormCloseQuery(Sender: TObject; var CanClose: boolean);
begin
...
procedure Txseusformi.Button1Click(Sender: TObject);
begin
  //restartserver;
end;


procedure Txseusformi.showlogClick(Sender: TObject);
begin
...
var
  ...
  repeat
    ...
    begin
      ...
      //xseusformi.memolog('Attending Connection. Error code (0=Success): ' +
...
{procedure Txseusformi.FormActivate(Sender: TObject);
begin
  xseusserver:=txseusserver.create;
  //inherited paint;
  //show;
...
procedure Txseusformi.FormDeactivate(Sender: TObject);
begin
